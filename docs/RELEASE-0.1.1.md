...
The real engine samples preceded the final metadata bookkeeping and startup fixes. Those fixes received ordinary regression and installed-executable checks; this release does not claim a repeated final-package mutation campaign.
